 ...
 */
function AddBusinessLoginButton({ className, children, variant = "default", size = "default", ...props }) {
 ...
 */
function ClaimBusinessLoginButton({ businessId, className, children, variant = "default", size = "default", ...props }) {
 ...
 */
function WriteReviewLoginButton({ businessId, className, children, variant = "default", size = "default", ...props }) {
 ...
 */
function SaveBusinessLoginButton({ businessId, className, children, variant = "default", size = "default", ...props }) {
 ...
 */
function BookServiceLoginButton({ businessId, className, children, variant = "default", size = "default", ...props }) {
 ...
 */
function DashboardLoginButton({ role = "user", className, children, variant = "default", size = "default", ...props }) {
 ...
 */
function PremiumLoginButton({ className, children, variant = "default", size = "default", ...props }) {
 ...
 */
function IntelligentLoginButton({ context = "default", contextParams = {}, className, children, variant = "default", size = "default", showIcon = true, showBadge = false, badgeText, ...props }) {
 ...
 */
function createIntelligentLoginLink(context, contextParams = {}) {
...
// Named exports for better tree-shaking and build compatibility
export { AddBusinessLoginButton, ClaimBusinessLoginButton, WriteReviewLoginButton, SaveBusinessLoginButton, BookServiceLoginButton, DashboardLoginButton, PremiumLoginButton, IntelligentLoginButton, createIntelligentLoginLink };
