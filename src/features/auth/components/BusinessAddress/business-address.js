	...
	return (
		<>
			<div className="space-y-6">
				...
				<Card className="border-primary/30 bg-blue-50 dark:border-primary dark:bg-primary/20">
						...
						render={({ field, fieldState }) => (
							<FormItem>
								...
								{validationTips.street && (
									<div className={`flex items-center gap-1 text-sm ${validationTips.street.startsWith("✓") ? "text-success" : "text-amber-600"}`}>
						...
						<FormField
							...
							render={({ field, fieldState }) => (
								<FormItem>
									...
									{validationTips.city && (
										<div className={`flex items-center gap-1 text-sm ${validationTips.city.startsWith("✓") ? "text-success" : "text-amber-600"}`}>
							...
							render={({ field, fieldState }) => (
								<FormItem>
									...
									{validationTips.state && (
										<div className={`flex items-center gap-1 text-sm ${validationTips.state.startsWith("✓") ? "text-success" : "text-amber-600"}`}>
						...
						<FormField
							...
							render={({ field, fieldState }) => (
								<FormItem>
									...
									{validationTips.zip && (
										<div className={`flex items-center gap-1 text-sm ${validationTips.zip.startsWith("✓") ? "text-success" : "text-amber-600"}`}>
