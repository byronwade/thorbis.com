...
const generateMainNavigation = (fromIndustry?: string) => {
  ...
  const navigation = [
    { name: "Dashboard", href: "/dashboards/rest", icon: ChefHat, description: "Restaurant business overview" },
...
const restaurantNavigation = [
  {
    ...
    items: [
      { name: "POS Terminal", href: "/dashboards/rest/pos", icon: CreditCard, description: "Point of sale and order management" },
      { name: "Kitchen Display", href: "/dashboards/rest/kds", icon: MonitorSpeaker, description: "Kitchen order queue and timing" },
      { name: "Floor Plan", href: "/dashboards/rest/floor", icon: LayoutGrid, description: "Table management and seating" },
      { name: "Reservations", href: "/dashboards/rest/reservations", icon: Calendar, description: "Table bookings and waitlist" }
    ]
  },
  {
    title: "Menu & Inventory",
    items: [
      { name: "Menus", href: "/dashboards/rest/menus", icon: BookOpen, description: "Items, pricing, and availability" },
      { name: "Inventory", href: "/dashboards/rest/inventory", icon: Package, description: "Ingredients and supplies" },
      { name: "Suppliers", href: "/dashboards/rest/suppliers", icon: Building, description: "Vendor management and ordering" }
    ]
  },
  {
    title: "Customers & Staff",
    items: [
      { name: "Customers", href: "/dashboards/rest/customers", icon: Users, description: "Customer database and loyalty" },
      { name: "Staff", href: "/dashboards/rest/staff", icon: UserCheck, description: "Employee scheduling and management" },
      { name: "Checks", href: "/dashboards/rest/checks", icon: BarChart3, description: "Sales and performance analytics" }
    ]
  }
]

export function RestaurantSidebar({ user: _user, parentIndustry }: RestaurantSidebarProps) {
  ...
  return (
    <Sidebar variant="inset" className="sidebar-content">
            ...
            <SidebarMenuButton size="lg" asChild>
              <Link href="/dashboards" className="relative">
                ...
                <div className="grid flex-1 text-left text-sm leading-tight">
                  <span className="truncate font-semibold">Restaurant</span>
                  <span className="truncate text-xs">Restaurant Management System</span>
                </div>
      ...
      <SidebarContent>
        ...
        {/* Restaurant-Specific Navigation */}
        {restaurantNavigation.map((section, sectionIndex) => {
