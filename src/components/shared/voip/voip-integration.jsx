    ...
    return (
      <div className={`fixed bottom-6 right-6 z-50 flex flex-col gap-2 ${className}`}>
        <button
          ...
          className="h-12 w-12 rounded-full bg-success hover:bg-success text-white shadow-lg flex items-center justify-center transition-all duration-200 hover:scale-105"
  ...
  return (
    <div className={`fixed bottom-6 right-6 z-50 flex flex-col gap-2 ${className}`}>
      <button
        ...
        className="h-12 w-12 rounded-full bg-primary hover:bg-primary text-white shadow-lg flex items-center justify-center transition-all duration-200 hover:scale-105"
      ...
      <button
        ...
        className="h-10 w-10 rounded-full bg-destructive hover:bg-destructive text-white shadow-lg flex items-center justify-center transition-all duration-200 hover:scale-105 text-xs"
  ...
  return (
    <div className={`flex gap-2 ${className}`}>
      <button
        ...
        className="flex items-center gap-2 px-4 py-2 bg-success text-white rounded-lg hover:bg-success disabled:opacity-50 disabled:cursor-not-allowed transition-all"
      >
      ...
      <button
        onClick={() => simulateIncomingCall("555-111-2222")}
        disabled={isCallActive}
        className="flex items-center gap-2 px-4 py-2 bg-destructive text-white rounded-lg hover:bg-destructive disabled:opacity-50 disabled:cursor-not-allowed transition-all"
      >
        <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L3.342 16.5c-.77.833.192 2.5 1.732 2.5z" />
        </svg>
