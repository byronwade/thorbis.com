          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <div className={cn(
                ...
                callState === "ringing" ? "bg-success animate-pulse" : "bg-primary"
              )} />
              ...
              {(callState === "connected" || callState === "on-hold") && (
                <div className="flex items-center gap-1 mr-2">
                  <div className="flex h-4 items-end gap-px">
                    <div className="w-1 bg-success" style={{ height: "3px" }} />
                    <div className="w-1 bg-success" style={{ height: "6px" }} />
                    <div className="w-1 bg-success" style={{ height: "9px" }} />
                    <div className="w-1 bg-success" style={{ height: "12px" }} />
                  </div>
                  <span className="text-xs text-success">HD</span>
                </div>
              )}
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1 min-w-0">
                <h3 className="font-semibold text-foreground truncate">{caller.name}</h3>
                <p className="text-sm text-muted-foreground truncate">{caller.company}</p>
                <p className="text-xs text-muted-foreground font-mono">{caller.phone}</p>
              </div>

              {callState === "connected" && (
                <Badge variant="outline" className="text-xs border-green-500/30 text-success">
                  <Circle className="h-2 w-2 fill-green-500 text-success mr-1" />
                  Live
                </Badge>
              )}
            </div>
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <Button
                    ...
                    className="flex-1 h-12 bg-success hover:bg-success text-white transition-all duration-200 hover:scale-105 active:scale-95"
                  >
                ...
                <div className="flex items-center gap-2">
                  <Button
                    ...
                    className={cn(
                      ...
                      controls.muted && "bg-destructive hover:bg-destructive text-white"
                    )}
                  >
