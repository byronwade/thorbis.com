...
const generateMainNavigation = (fromIndustry?: string) => {
  ...
  const navigation = [
    { name: "Dashboard", href: "/dashboards/ret", icon: Store, description: "Retail business overview" },
...
// Retail-specific navigation
const retailNavigation = [
  {
    title: "Sales & Orders",
    items: [
      { name: "POS Terminal", href: "/dashboards/ret/pos", icon: CreditCard, description: "Point of sale system" },
      { name: "Orders", href: "/dashboards/ret/orders", icon: Clipboard, description: "Sales orders and transactions" },
      { name: "Returns", href: "/dashboards/ret/returns", icon: RefreshCw, description: "Returns and exchanges" }
    ]
  },
  {
    title: "Inventory & Products",
    items: [
      { name: "Products", href: "/dashboards/ret/products", icon: Package, description: "Product catalog and pricing" },
      { name: "Inventory", href: "/dashboards/ret/inventory", icon: Boxes, description: "Stock levels and tracking" },
      { name: "Suppliers", href: "/dashboards/ret/suppliers", icon: Building, description: "Vendor and purchasing" }
    ]
  },
  {
    title: "Customers & Staff",
    items: [
      { name: "Customers", href: "/dashboards/ret/customers", icon: Users, description: "Customer database and loyalty" },
      { name: "Staff", href: "/dashboards/ret/staff", icon: UserCheck, description: "Employee management" },
      { name: "Reports", href: "/dashboards/ret/reports", icon: BarChart3, description: "Sales and performance analytics" }
    ]
  }
]

export function RetailSidebar({ user: _user, parentIndustry }: RetailSidebarProps) {
  ...
  return (
    <Sidebar variant="inset" className="sidebar-content">
            ...
            <SidebarMenuButton size="lg" asChild>
              <Link href="/dashboards" className="relative">
                ...
                <div className="grid flex-1 text-left text-sm leading-tight">
                  <span className="truncate font-semibold">Retail</span>
                  <span className="truncate text-xs">Retail Management System</span>
                </div>
      ...
      <SidebarContent>
        ...
        {/* Retail-Specific Navigation */}
        {retailNavigation.map((section, sectionIndex) => {
