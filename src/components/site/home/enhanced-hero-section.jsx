...
export default function EnhancedHeroSection() {
  ...
  return (
    <section className="relative min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      ...
      <div className="relative px-4 py-8 sm:py-12 lg:py-16 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          {/* Main Hero Content */}
          <div className="text-center mb-8 sm:mb-12 lg:mb-16">
            <Badge variant="secondary" className="mb-4 sm:mb-6 px-3 py-1.5 sm:px-4 sm:py-2 text-xs sm:text-sm font-medium">
              🚀 Unified Local Discovery & Field Service Platform
            </Badge>
            
            <h1 className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tight mb-4 sm:mb-6">
            ...
            <p className="max-w-3xl mx-auto text-base sm:text-lg md:text-xl lg:text-2xl text-muted-foreground dark:text-muted-foreground mb-6 sm:mb-8 px-2">
