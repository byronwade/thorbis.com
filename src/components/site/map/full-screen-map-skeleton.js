...
const FullScreenMapSkeleton = ({ className = "" }) => {
  return (
    <div className={`relative w-full h-full bg-gray-100 dark:bg-gray-900 rounded-lg overflow-hidden ${className}`}>
        ...
        <div className="absolute inset-0 opacity-20">
          <div className="grid grid-cols-6 grid-rows-4 h-full w-full gap-px">
            {Array.from({ length: 24 }).map((_, i) => (
              <div key={i} className="bg-gray-300 dark:bg-gray-700 animate-pulse" />
            ))}
          </div>
        </div>
      </div>
      ...
      <div className="absolute top-4 left-4 right-4 z-10">
        <div className="flex items-center space-x-2">
          <Skeleton className="flex-1 h-12 rounded-full bg-white/80 dark:bg-gray-800/80" />
          <Skeleton className="w-12 h-12 rounded-full bg-white/80 dark:bg-gray-800/80" />
        </div>
      </div>

      {/* Map Controls */}
      <div className="absolute top-20 right-4 z-10 space-y-2">
        <Skeleton className="w-10 h-10 rounded-lg bg-white/80 dark:bg-gray-800/80" />
        <Skeleton className="w-10 h-10 rounded-lg bg-white/80 dark:bg-gray-800/80" />
        <Skeleton className="w-10 h-10 rounded-lg bg-white/80 dark:bg-gray-800/80" />
      </div>
      ...
      <div className="absolute inset-0 z-5">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
          <div className="w-8 h-8 bg-red-500/60 rounded-full border-2 border-white animate-pulse shadow-lg">
        ...
        <div className="absolute top-1/3 left-1/4 transform -translate-x-1/2 -translate-y-1/2">
          <div className="w-6 h-6 bg-blue-500/60 rounded-full border-2 border-white animate-pulse shadow-lg" />
        </div>
        
        <div className="absolute top-2/3 right-1/3 transform translate-x-1/2 -translate-y-1/2">
          <div className="w-6 h-6 bg-green-500/60 rounded-full border-2 border-white animate-pulse shadow-lg" />
        </div>
        ...
        <div className="absolute top-1/4 right-1/4 transform translate-x-1/2 -translate-y-1/2">
          <div className="w-6 h-6 bg-orange-500/60 rounded-full border-2 border-white animate-pulse shadow-lg" />
        </div>
      </div>
