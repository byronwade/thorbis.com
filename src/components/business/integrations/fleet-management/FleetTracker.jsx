...
import { RealTimeTracker, RealTimeAlerts } from "./components/RealTimeTracker"
import { RouteVisualization, MapRouteVisualization } from "./components/RouteVisualization"
import { Vehicle3DIcon } from "./components/Vehicle3DIcon"
...
/**
 * FleetTracker - Enterprise Fleet Management Dashboard
 * Renamed from FleetManagementPro to follow new naming conventions
 * Provides real-time vehicle tracking, monitoring, and management
 */
                ...
                {expandedSections.dispatch && (
                  <div className="px-4 pb-4 space-y-3">
                    <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-3">
                      <div className="text-sm font-medium text-blue-400 mb-1">Current Job</div>
                      <div className="text-xs text-gray-400">Pickup: Atlanta Warehouse</div>
                      <div className="text-xs text-gray-400">Delivery: Birmingham, AL</div>
                      <div className="text-xs text-gray-400">ETA: 2:30 PM</div>
                    </div>
                    <div className="space-y-2">
                      <div className="flex justify-between text-sm">
