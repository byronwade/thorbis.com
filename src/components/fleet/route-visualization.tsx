...
import { MapPin, Flag, Route, CheckCircle2, Circle } from "lucide-react"
import { Vehicle3DIcon } from "./vehicle-3d-icons"
...
export function RouteVisualization({ vehicle, className }: RouteVisualizationProps) {
...
interface MapRouteVisualizationProps {
  vehicles: Vehicle[]
  selectedVehicle?: number | null
  onVehicleSelect?: (vehicleId: number) => void
}

export function MapRouteVisualization({ vehicles, selectedVehicle, onVehicleSelect }: MapRouteVisualizationProps) {
  return (
    <div className="relative w-full h-full">
      {/* Simulated Map Background */}
      <div className="absolute inset-0 bg-gradient-to-br from-secondary/10 to-secondary/30 rounded-lg">
        {/* Grid Pattern */}
            ...
            return (
              <g key={vehicle.id}>
                ...
                >
                  ...
                  {/* Vehicle Label */}
                  <text y="35" textAnchor="middle" className="text-xs fill-foreground font-medium">
