            ...
            <div className="max-w-7xl mx-auto px-6">
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-16 items-center">
                ...
                >
                  ...
                  <h3 className="text-2xl md:text-3xl lg:text-4xl font-light mb-8 text-muted-foreground leading-snug">
                    {feature.subtitle}
                  </h3>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {[
                      ...
                      >
                        ...
                        <div className="text-sm text-muted-foreground">{material.detail}</div>
                      </motion.div>
                    ))}
                  </div>
                </motion.div>
            ...
            <div className="max-w-7xl mx-auto px-6">
              <div className="text-center mb-16">
                ...
                >
                  ...
                  <p className="text-lg md:text-xl text-muted-foreground leading-relaxed font-light max-w-4xl mx-auto mb-16">
                    {feature.description}
                  </p>
                </motion.div>
              </div>
  ...
  const visualComponents = {
    speed: (
      <div className="relative w-full max-w-lg mx-auto">
        ...
        {/* Floating elements */}
        <motion.div 
          className="absolute -top-6 -right-6 bg-primary shadow-lg rounded-2xl px-4 py-2 border border-primary"
          initial={{ opacity: 0, scale: 0.8 }}
          whileInView={{ opacity: 1, scale: 1 }}
          transition={{ duration: 0.3, delay: 0.15 }}
        >
          <div className="text-sm font-medium text-white">ARM RK3588S</div>
          <div className="text-xs text-primary/80">8-core processor</div>
        </motion.div>
      </div>
    ),
        ...
        <div className="aspect-square bg-neutral-800 rounded-3xl flex items-center justify-center shadow-2xl relative overflow-hidden border border-neutral-700">
          ...
          >
            {[...Array(8)].map((_, i) => (
              <motion.div
                key={i}
                className="absolute w-2 h-2 bg-primary/40 rounded-full opacity-60"
                style={{
                  left: `${20 + i * 10}%`,
                  top: `${15 + (i % 3) * 20}%`
                }}
          ...
          <div className="bg-card rounded-2xl p-6 mb-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <div className="text-muted-foreground text-sm">Tap, dip, or swipe</div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 gap-3">
              {[1, 2, 3].map((i) => (
                <motion.div
                  key={i}
                  className="bg-muted rounded-xl p-4 h-16 flex items-center justify-center hover:bg-muted transition-colors cursor-pointer"
    ...
    security: (
      <div className="relative w-full max-w-lg mx-auto">
        <div className="aspect-square bg-neutral-800 rounded-3xl flex items-center justify-center shadow-2xl border border-neutral-700">
          <div className="text-center">
            <div className="w-20 h-20 mx-auto bg-success rounded-2xl flex items-center justify-center mb-6">
        ...
        {/* Security indicators */}
        <motion.div 
          className="absolute -bottom-4 left-1/2 transform -translate-x-1/2 bg-success text-white px-4 py-2 rounded-full text-sm font-medium shadow-lg"
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <div className="flex space-x-1">
              {[0, 0.2, 0.4].map((delay, i) => (
                <motion.div
                  key={i}
                  className="w-2 h-2 bg-success/40 rounded-full"
    ...
    materials: (
      <div className="relative w-full max-w-md mx-auto">
        <div className="relative">
          ...
          />
          <motion.div 
            className="absolute top-8 left-8 w-64 h-64 bg-gradient-to-br from-gray-800 to-gray-900 rounded-3xl shadow-2xl border border-border flex items-center justify-center"
            initial={{ opacity: 0, scale: 0.8 }}
            whileInView={{ opacity: 1, scale: 1 }}
            transition={{ duration: 0.4, delay: 0.2 }}
          >
            <div className="text-center text-white">
              <Monitor className="w-20 h-20 mx-auto mb-4 text-muted-foreground" />
              <div className="text-sm font-medium">Graphite Finish</div>
              <div className="text-xs text-muted-foreground">400-600 grit</div>
            </div>
          </motion.div>
          
          {/* Material indicators */}
          <motion.div 
            className="absolute -top-4 -right-4 bg-muted text-white px-3 py-2 rounded-xl text-xs font-medium border border-border"
            initial={{ opacity: 0, scale: 0.8 }}
            whileInView={{ opacity: 1, scale: 1 }}
    ...
    reliability: (
      <div className="relative w-full max-w-lg mx-auto">
        <div className="aspect-square bg-card rounded-3xl flex items-center justify-center shadow-2xl border border-border">
          <div className="text-center">
            <div className="w-16 h-24 mx-auto bg-success rounded-lg flex items-center justify-center mb-4 relative">
              {/* Battery level indicator */}
              <div className="absolute inset-2 bg-success/40 rounded" />
              <div className="absolute -top-1 left-1/2 transform -translate-x-1/2 w-4 h-1 bg-muted rounded-full" />
            </div>
        ...
        {/* Status indicator */}
        <motion.div 
          className="absolute top-4 right-4 flex items-center space-x-2 bg-muted shadow-lg rounded-full px-3 py-2 border border-border"
          initial={{ opacity: 0, scale: 0.8 }}
          whileInView={{ opacity: 1, scale: 1 }}
          transition={{ duration: 0.3, delay: 0.15 }}
        >
    ...
    performance: (
      <div className="w-full max-w-6xl mx-auto">
              ...
              {[
                ...
                >
                  <div className="flex justify-between items-center text-white font-medium">
                    ...
                    <span className="text-success text-sm">{item.multiplier}</span>
                  </div>
                  
                  <div className="grid grid-cols-2 gap-4">
                    {/* Thorbis bar */}
                    <div className="space-y-2">
                      <div className="text-xs text-muted-foreground">Thorbis POS</div>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="text-xs text-muted-foreground">{item.competitors}</div>
                    </div>
                  </div>
                </motion.div>
              ))}
        ...
        {/* Bottom testimonial */}
        <motion.div
          className="mt-16 text-center bg-card/30 backdrop-blur-sm rounded-2xl p-8 border border-border"
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.4, delay: 0.4 }}
        >
          <div className="text-xl text-muted-foreground mb-4 italic max-w-3xl mx-auto">
          ...
          <div className="text-sm text-muted-foreground">Downtown Bistro, San Francisco</div>
        </motion.div>
      </div>
    )
  };

  return visualComponents[feature.visual] || <div className="w-64 h-64 bg-card rounded-3xl" />;
};
...
const BentoCard = ({ section, index }) => {
  ...
  const getColorClasses = (color) => {
    const colors = {
      blue: 'from-blue-500/20 to-blue-600/20 border-primary/30',
      purple: 'from-purple-500/20 to-purple-600/20 border-border/30',
      green: 'from-green-500/20 to-green-600/20 border-success/30',
      orange: 'from-orange-500/20 to-orange-600/20 border-warning/30',
      teal: 'from-teal-500/20 to-teal-600/20 border-success/30'
    };
    return colors[color] || 'from-gray-500/20 to-gray-600/20 border-border/30';
  };
  ...
  const renderContent = () => {
    switch (section.type) {
      ...
      case 'visual-compact':
        return (
          <div className="h-full flex flex-col justify-center p-4 bg-gradient-to-br from-gray-800 to-gray-900 border border-border rounded-2xl">
