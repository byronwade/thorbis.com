...
export interface AppNavigationProps {
  industry: 'hs' | 'rest' | 'auto' | 'ret' | 'books' | 'payroll'
  className?: string
  collapsed?: boolean
    ...
    items: [
      {
        ...
        keywords: ['overview', 'financial', 'reports']
      },
      {
        label: 'Invoices',
        href: '/books/invoices',
        ...
        keywords: ['billing', 'invoices', 'receivables']
      },
      {
        label: 'Transactions',
        ...
        keywords: ['transactions', 'records', 'history']
      },
      {
        label: 'Reports',
        href: '/books/reports',
      ...
      {
        label: 'Customers',
        href: '/books/customers',
        icon: Users,
        description: 'Customer accounts and billing',
        keywords: ['customers', 'accounts', 'billing']
      },
      {
        label: 'Settings',
        href: '/books/settings',
    ...
    items: [
      {
        ...
        href: '/payroll',
        icon: Home,
        description: 'Payroll overview and summary',
        keywords: ['overview', 'payroll', 'summary']
      },
      {
        label: 'Employees',
        ...
        keywords: ['employees', 'staff', 'records']
      },
      {
        label: 'Timesheets',
        ...
        keywords: ['timesheets', 'time tracking', 'hours']
      },
      {
        label: 'Reports',
        href: '/payroll/reports',
        icon: FileText,
        description: 'Payroll reports and compliance',
        keywords: ['reports', 'compliance', 'taxes']
      },
      {
        label: 'Settings',
        href: '/payroll/settings',
        icon: Settings,
        description: 'Payroll system configuration',
        keywords: ['configuration', 'preferences', 'setup']
      }
    ]
  }
