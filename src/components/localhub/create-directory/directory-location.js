						...
						<FormField
							...
							render={({ field, fieldState }) => (
								<FormItem>
									...
									<FormControl>
										<Input {...field} placeholder="Raleigh" className={fieldState.error ? "border-destructive" : ""} />
									</FormControl>
									{validationTips.city && (
						...
						<FormField
							...
							render={({ field, fieldState }) => (
								<FormItem>
									...
									<FormControl>
										<Input {...field} placeholder="27601" className={fieldState.error ? "border-destructive" : ""} />
									</FormControl>
									{validationTips.zip && (
