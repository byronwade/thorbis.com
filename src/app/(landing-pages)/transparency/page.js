...
function InteractiveCard({ icon: Icon, title, children, color = "blue" }) {
	const colorClasses = {
		blue: "group-hover:border-blue-500 group-hover:shadow-blue-500/20",
		green: "group-hover:border-green-500 group-hover:shadow-green-500/20",
		purple: "group-hover:border-purple-500 group-hover:shadow-purple-500/20",
		orange: "group-hover:border-orange-500 group-hover:shadow-orange-500/20",
	};
	...
	return (
		<div className="flex gap-4 group">
			<div className="flex flex-col items-center">
				<div className="w-4 h-4 bg-blue-600 dark:bg-blue-400 rounded-full border-4 border-white dark:border-slate-900 group-hover:scale-125 transition-transform duration-300"></div>
...
function AlgorithmStep({ step, title, description, icon: Icon }) {
	return (
		<div className="flex gap-4 p-6 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-700 hover:border-blue-300 dark:hover:border-blue-600 transition-all duration-300 hover:shadow-lg group">
			<div className="flex-shrink-0">
				<div className="w-10 h-10 bg-blue-50 dark:bg-blue-900/20 rounded-lg flex items-center justify-center group-hover:bg-blue-100 dark:group-hover:bg-blue-900/40 transition-colors duration-300">
	...
	return (
		<div className="min-h-screen bg-white dark:bg-slate-900">
			...
			<section className="relative overflow-hidden">
				...
				<div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32">
					<div className="text-center">
						<Badge variant="secondary" className="mb-8 text-sm font-medium bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-300 border-blue-200 dark:border-blue-800 hover:bg-blue-100 dark:hover:bg-blue-900/30 transition-colors duration-300">
						...
						<h1 className="text-5xl lg:text-7xl font-bold text-slate-900 dark:text-white mb-8 leading-tight">
							...
							<span className="block text-blue-600 dark:text-blue-400">Transparency</span>
						...
						<div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
							<Button asChild size="lg" className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 text-lg font-medium transition-all duration-300 hover:scale-105 hover:shadow-lg group">
							...
							<Button asChild variant="outline" size="lg" className="px-8 py-4 text-lg font-medium border-2 border-slate-200 dark:border-slate-700 hover:border-blue-300 dark:hover:border-blue-600 transition-all duration-300 hover:scale-105">
								<Link href="#algorithm">
			...
			<section className="py-20 bg-slate-50 dark:bg-slate-800/50">
				<div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="text-center mb-12">
						<Badge variant="outline" className="mb-4 bg-white dark:bg-slate-900 border-blue-200 dark:border-blue-800">
			...
			<section className="py-20 bg-white dark:bg-slate-900">
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="text-center mb-16">
						<Badge variant="outline" className="mb-4 bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-300 border-blue-200 dark:border-blue-800">
					...
					<div className="grid lg:grid-cols-2 gap-8 mb-16">
						<InteractiveCard icon={Eye} title="100% Open Source" color="blue">
							<div className="space-y-4 text-slate-700 dark:text-slate-300">
								<div className="flex items-center gap-3 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg hover:bg-blue-100 dark:hover:bg-blue-900/30 transition-colors duration-300">
									<CheckCircle className="w-5 h-5 text-green-600 dark:text-green-400 flex-shrink-0" />
									<span>
										All review and moderation logic is public on{" "}
										<a href={GITHUB_REPO} className="font-medium text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 inline-flex items-center gap-1 transition-colors duration-200" target="_blank" rel="noopener noreferrer">
								...
								<div className="flex items-center gap-3 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg hover:bg-blue-100 dark:hover:bg-blue-900/30 transition-colors duration-300">
									...
									<span>
										Complete{" "}
										<a href={CHANGELOG_URL} className="font-medium text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 inline-flex items-center gap-1 transition-colors duration-200" target="_blank" rel="noopener noreferrer">
						...
						<InteractiveCard icon={ShieldCheck} title="Community Audited" color="green">
							<div className="space-y-4 text-slate-700 dark:text-slate-300">
								<div className="flex items-center gap-3 p-3 bg-green-50 dark:bg-green-900/20 rounded-lg hover:bg-green-100 dark:hover:bg-green-900/30 transition-colors duration-300">
									<CheckCircle className="w-5 h-5 text-green-600 dark:text-green-400 flex-shrink-0" />
						...
						<InteractiveCard icon={ListChecks} title="User & Business Rights" color="purple">
							<div className="space-y-4 text-slate-700 dark:text-slate-300">
								<div className="flex items-center gap-3 p-3 bg-purple-50 dark:bg-purple-900/20 rounded-lg hover:bg-purple-100 dark:hover:bg-purple-900/30 transition-colors duration-300">
									<CheckCircle className="w-5 h-5 text-green-600 dark:text-green-400 flex-shrink-0" />
						...
						<InteractiveCard icon={Star} title="Algorithm Transparency" color="orange">
							<div className="space-y-4 text-slate-700 dark:text-slate-300">
								<div className="flex items-center gap-3 p-3 bg-orange-50 dark:bg-orange-900/20 rounded-lg hover:bg-orange-100 dark:hover:bg-orange-900/30 transition-colors duration-300">
									<CheckCircle className="w-5 h-5 text-green-600 dark:text-green-400 flex-shrink-0" />
					...
					<div className="bg-slate-50 dark:bg-slate-800/50 rounded-2xl p-8 lg:p-12">
						...
						<div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
							<div className="text-center p-4 bg-white dark:bg-slate-900 rounded-xl hover:shadow-lg transition-all duration-300 group">
								<div className="text-2xl lg:text-3xl font-bold text-blue-600 dark:text-blue-400 mb-2 group-hover:scale-110 transition-transform duration-300">99.9%</div>
								<div className="text-sm text-slate-600 dark:text-slate-400">Algorithm Uptime</div>
							</div>
							<div className="text-center p-4 bg-white dark:bg-slate-900 rounded-xl hover:shadow-lg transition-all duration-300 group">
								<div className="text-2xl lg:text-3xl font-bold text-green-600 dark:text-green-400 mb-2 group-hover:scale-110 transition-transform duration-300">156</div>
								<div className="text-sm text-slate-600 dark:text-slate-400">Code Contributors</div>
							</div>
							<div className="text-center p-4 bg-white dark:bg-slate-900 rounded-xl hover:shadow-lg transition-all duration-300 group">
								<div className="text-2xl lg:text-3xl font-bold text-purple-600 dark:text-purple-400 mb-2 group-hover:scale-110 transition-transform duration-300">2.3M</div>
								<div className="text-sm text-slate-600 dark:text-slate-400">Reviews Processed</div>
							</div>
							<div className="text-center p-4 bg-white dark:bg-slate-900 rounded-xl hover:shadow-lg transition-all duration-300 group">
								<div className="text-2xl lg:text-3xl font-bold text-orange-600 dark:text-orange-400 mb-2 group-hover:scale-110 transition-transform duration-300">&lt;1s</div>
					...
					<div className="bg-white dark:bg-slate-900 rounded-2xl p-8 lg:p-12 border border-slate-200 dark:border-slate-700">
						...
						<div className="grid lg:grid-cols-3 gap-8">
							<div className="text-center">
								...
								<p className="text-green-600 dark:text-green-400 font-medium">Fully Operational</p>
							...
							<div className="text-center">
								...
								<p className="text-blue-600 dark:text-blue-400 font-medium">Maximum</p>
							...
							<div className="text-center">
								...
								<p className="text-purple-600 dark:text-purple-400 font-medium">847ms avg</p>
					...
					<div className="grid lg:grid-cols-2 gap-12">
						...
						<div className="bg-slate-50 dark:bg-slate-800/50 rounded-2xl p-8">
							...
							<div className="mt-8 pt-6 border-t border-slate-200 dark:border-slate-700">
								<Button asChild variant="outline" className="w-full border-blue-200 dark:border-blue-800 hover:bg-blue-50 dark:hover:bg-blue-900/20">
			...
			<section className="py-20 bg-slate-50 dark:bg-slate-800/50">
				<div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="text-center mb-16">
						<Badge variant="outline" className="mb-4 bg-white dark:bg-slate-900 border-green-200 dark:border-green-800">
					...
					<div className="grid lg:grid-cols-2 gap-12">
						{/* Board Information */}
						<Card className="bg-white dark:bg-slate-900 border-0 shadow-xl hover:shadow-2xl transition-all duration-500 overflow-hidden group">
							<div className="absolute inset-0 bg-green-50 dark:bg-green-900/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
						...
						<div className="space-y-6">
							<div className="bg-white dark:bg-slate-900 rounded-xl p-6 border border-slate-200 dark:border-slate-700 hover:shadow-lg transition-all duration-300 group">
								...
								<Button asChild variant="outline" size="sm" className="group-hover:bg-blue-50 dark:group-hover:bg-blue-900/20">
							...
							<div className="bg-white dark:bg-slate-900 rounded-xl p-6 border border-slate-200 dark:border-slate-700 hover:shadow-lg transition-all duration-300 group">
								...
								<Button asChild variant="outline" size="sm" className="group-hover:bg-green-50 dark:group-hover:bg-green-900/20">
									<Link href="#" target="_blank" rel="noopener noreferrer">
										<FileText className="mr-2 w-4 h-4" />
										Read Full Report
									</Link>
				...
				<div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="text-center mb-16">
						...
						<h2 className="text-4xl lg:text-6xl font-bold text-slate-900 dark:text-white mb-6">
							...
							<span className="block text-blue-600 dark:text-blue-400">Trusted Platform</span>
						</h2>
					...
					<div className="grid md:grid-cols-3 gap-8 mb-16">
						<Card className="group bg-slate-50 dark:bg-slate-800/50 border-0 hover:shadow-xl hover:-translate-y-2 transition-all duration-500">
							<CardContent className="p-8 text-center">
								<div className="w-16 h-16 bg-blue-100 dark:bg-blue-900/20 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
						...
						<Card className="group bg-slate-50 dark:bg-slate-800/50 border-0 hover:shadow-xl hover:-translate-y-2 transition-all duration-500">
							<CardContent className="p-8 text-center">
								<div className="w-16 h-16 bg-green-100 dark:bg-green-900/20 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
								...
								<Button asChild variant="outline" className="w-full border-green-200 dark:border-green-800 hover:bg-green-50 dark:hover:bg-green-900/20">
						...
						<Card className="group bg-slate-50 dark:bg-slate-800/50 border-0 hover:shadow-xl hover:-translate-y-2 transition-all duration-500">
							<CardContent className="p-8 text-center">
								<div className="w-16 h-16 bg-purple-100 dark:bg-purple-900/20 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
								...
								<Button asChild variant="outline" className="w-full border-purple-200 dark:border-purple-800 hover:bg-purple-50 dark:hover:bg-purple-900/20">
									<Link href="/contact-support">
										<Users className="mr-2 w-4 h-4" />
										Get in Touch
									</Link>
